...
echo "
<form action='?module=input_jenjang' method='post'>
<table cellpadding='0' cellspacing='0' border='0'>
<tr><td colspan='3' bgcolor='#0066CC' valign='center'><font size='+1' color='#FFFFFF'>Tambah jenjang</font></td></tr>
<tr><td width='150' align='center'>jenjang</td><td><input type='text' name='kat' maxlength='100'/></td></tr>
