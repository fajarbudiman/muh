...
echo "
<form action='?module=input_kategori' method='post'>
<table cellpadding='0' cellspacing='0' border='1'>
<tr><td colspan='3' bgcolor='#0066CC' valign='center'><font size='+1' color='#FFFFFF'>Tambah Kategori</font></td></tr>
<tr><td width='150' align='center'>Kategori</td><td><input type='text' name='kat' maxlength='100'/></td></tr>
